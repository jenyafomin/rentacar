...
// Type Imports
import type { Mode, SystemMode } from '@/front/@core/types'

// Component Imports
import VerticalNav, { NavHeader, NavCollapseIcons } from '@/front/@menu/vertical-menu'
...
// Style Imports
import navigationCustomStyles from '@/front/@core/styles/vertical/navigationCustomStyles'
