...
// Component Imports
import HorizontalNav, { Menu, MenuItem } from '@/front/@menu/horizontal-menu'
...
import StyledHorizontalNavExpandIcon from '@/front/@menu/styles/horizontal/StyledHorizontalNavExpandIcon'
import StyledVerticalNavExpandIcon from '@/front/@menu/styles/vertical/StyledVerticalNavExpandIcon'

// Style Imports
import menuItemStyles from '@/front/@core/styles/horizontal/menuItemStyles'
import menuRootStyles from '@/front/@core/styles/horizontal/menuRootStyles'
import verticalNavigationCustomStyles from '@/front/@core/styles/vertical/navigationCustomStyles'
import verticalMenuItemStyles from '@/front/@core/styles/vertical/menuItemStyles'
import verticalMenuSectionStyles from '@/front/@core/styles/vertical/menuSectionStyles'
