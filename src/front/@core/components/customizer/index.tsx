...
import SkinBordered from '@/front/@core/svg/SkinBordered'
import LayoutVertical from '@/front/@core/svg/LayoutVertical'
import LayoutCollapsed from '@/front/@core/svg/LayoutCollapsed'
import LayoutHorizontal from '@/front/@core/svg/LayoutHorizontal'
import ContentCompact from '@/front/@core/svg/ContentCompact'
import ContentWide from '@/front/@core/svg/ContentWide'
import DirectionLtr from '@/front/@core/svg/DirectionLtr'
