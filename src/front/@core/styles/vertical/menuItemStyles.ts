...
// Type Imports
import type { MenuItemStyles } from '@/front/@menu/types'
import type { Settings } from '@/front/@core/contexts/settingsContext'
import type { VerticalNavState } from '@/front/@menu/contexts/verticalNavContext'

// Util Imports
import { menuClasses } from '@/front/@menu/utils/menuClasses'
            ...
            background:
              theme.direction === 'ltr'
                ? `linear-gradient(270deg,
                    rgb(var(--mui-palette-primary-mainChannel) / 0.6) 0%,
