                ...
                <DsnGrid className="container" col={2} colTablet={1}>
                    <div className="p-relative box-left">
                        <div className="box-im h-100 ">
                            <Image className="cover-bg-img " src="/img/rachel-claire.jpg" alt="" layout="fill" sizes="(max-width: 768px) 100vw,(max-width: 1200px) 75vw,100vw"/>
                        </div>
                    </div>
            ...
            <div className="p-relative section-margin" data-dsn-title="BUSINESS CONSULTING">
                <DsnGrid className="container" col={2} colTablet={1}>
                    ...
                    <div className="p-relative box-right order-md-1">
                        <div className="box-im h-100 ">
                            <Image className="cover-bg-img " src="/img/help-project.jpg" alt="" layout="fill" sizes="(max-width: 768px) 100vw,(max-width: 1200px) 75vw"/>
                        </div>
                    </div>
            ...
            <div className="p-relative background-section section-padding" data-dsn-title="Project Manager">
                ...
                <div className="container">
                    ...
                    <DsnGrid className="background-main" col={2} colTablet={1} rowGapTablet={0} rowGapMobile={0}>
                        ...
                        <div className="p-relative box-right order-md-1">
                            <div className="box-im h-100 ">
                                <Image className="cover-bg-img " src="/img/corporate.jpg" alt="" layout="fill"  sizes="(max-width: 768px) 100vw,(max-width: 1200px) 75vw"/>
                            </div>
                        </div>
                    </DsnGrid>
                    <ServiceGrid className="mt-50 p-0 text-center" data={getServiceData().slice(0, 3) as any} col={3} colTablet={2}
                                 colGap={50}/>
                </div>
